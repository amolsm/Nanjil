<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenrateBillThermal.aspx.cs" Inherits="Dairy.Tabs.Administration.GenrateBillThermal" %>
  ...
  <%--  <script type="text/javascript">
    ...
    <script type = "text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write("<html> <head> <style type='text/css'>.style1{border-collapse:collapse;font-size:145%; font-family: sans-serif;}</style>");
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Generate bill Info</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Generate Bill"></asp:Label> </h3>
                ...
                <%--   <div class="col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:TextBox ID="txtTop" class="form-control" placeholder="Select Last TOP Order" runat="server" required ToolTip="Enter last top Number"  ></asp:TextBox>           
