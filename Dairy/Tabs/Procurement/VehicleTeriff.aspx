<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehicleTeriff.aspx.cs" Inherits="Dairy.Tabs.Procurement.VehicleTeriff" %>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtVehicleName" class="form-control" placeholder="Vehicle Type" runat="server" required ToolTip="Vehicle Type"></asp:TextBox>                        
                    </div><!-- /.input group -->
