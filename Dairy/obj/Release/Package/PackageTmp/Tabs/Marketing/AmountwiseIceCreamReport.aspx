                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtStartAmt" class="form-control"   placeholder="Start Amount" runat="server" required  ></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                     ...
                     End Amount
                       ...
                       <asp:TextBox ID="txtEndAmt" class="form-control"   placeholder="End Amount" runat="server" required  ></asp:TextBox>                        
                    </div><!-- /.input group -->
