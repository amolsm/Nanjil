<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DuplicateBillForAgent.aspx.cs" Inherits="Dairy.Tabs.Reception.DuplicateBillForAgent" %>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Generate Duplicate Bill"></asp:Label> </h3>
           ...
           <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:TextBox ID="txtEndBillNo" class="form-control" placeholder="EndRange Of BillNo" runat="server"  ToolTip="Enter Bill Number" Visible="false" ></asp:TextBox>           
