<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenrateBillThermal.aspx.cs" Inherits="Dairy.Tabs.Reception.GenrateBillThermal" %>
  ...
  <%--  <script type="text/javascript">
    ...
    <script type = "text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write("<html> <head> <style type='text/css'>.style1{border-collapse:collapse;font-size:150%; font-family: sans-serif;}</style>");
